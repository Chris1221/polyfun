...
from .ldsc_polyfun import sumstats as sumstats
...
def polyfun_ldsc(
    ...
    loco=False,
    num_chr_sets=22,
    no_standardize_ridge=False,
    anno=None,
    ridge_lambda=None,
    reestimate_lambdas=False,
    ridge_jackknife=False,
):
    log = Logger(out + ".log")
    if out is None:
    ...
    if ridge_lambda:
        assert loco, "--ridge_lambda can only be used with --loco"
